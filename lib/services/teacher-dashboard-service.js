...
export const TeacherDashboardService = {
  ...
  async getDashboardData(teacherId) {
    ...
    const [teacher, classes, recentTugas, recentAbsensi, activeTA] = await Promise.all([
      ...
      // 2. Classes Taught (through Pengampu)
      ...
      // 3. Recent Tasks Created by this Teacher
      ...
      // 4. Recent Attendance Records (Today's summary if possible)
